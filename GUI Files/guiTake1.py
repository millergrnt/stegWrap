...
class Page1(Page):
    def __init__(self, *args, **kwargs):
        ...
        submitButton = tk.Button(self, command=self.buttonClick, text="Submit", width=5, height=5)
        submitButton.pack(side="left", width=5, height=5)
    ...
    def buttonClick(self):
        ...
        self.text.delete(tk.BEGINNING, tk.END)
